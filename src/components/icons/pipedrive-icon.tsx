...
interface PipedriveIconProps extends SVGProps<SVGSVGElement> {
  className?: string;
}

export const PipedriveIcon = ({ className, ...props }: PipedriveIconProps) => (
  <svg 
    viewBox="0 0 304 304" 
    className={className}
    {...props}
  >
    ...
    <g transform="translate(67.000000, 44.000000)" fill="white" fillRule="evenodd">
      <mask id="pipedrive-mask" fill="white">
        <use href="#pipedrive-path" />
      </mask>
      <use fill="white" href="#pipedrive-path" />
    </g>
  </svg>
);
